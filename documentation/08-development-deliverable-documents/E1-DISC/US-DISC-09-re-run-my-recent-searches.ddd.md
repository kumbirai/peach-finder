---
title: DDD — US-DISC-09 — Re-run my recent searches
updated: 2026-09-04
---

# US-DISC-09 — Re-run my recent searches
...
- Recent searches stored per device (first-party storage only, SR-PRIV-04); one tap re-runs query + filters; clearable.
