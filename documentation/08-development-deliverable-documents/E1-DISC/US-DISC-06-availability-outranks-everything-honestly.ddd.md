---
title: DDD — US-DISC-06 — Availability outranks everything, honestly
updated: 2026-09-04
---

# US-DISC-06 — Availability outranks everything, honestly
...
FR-SRCH-03, FR-SRCH-08, FR-SRCH-09.

## 4. Build blueprint

**Primary LLD module:** `discovery-search` (`../../05-low-level-design/04-discovery-search/discovery-search-lld.md`)
**Supporting modules:** `listing-billing` (`../../05-low-level-design/09-listing-billing/listing-billing-lld.md`)
