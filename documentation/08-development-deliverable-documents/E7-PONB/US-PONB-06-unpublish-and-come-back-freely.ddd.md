---
title: DDD — US-PONB-06 — Unpublish and come back freely
updated: 2026-09-04
---

# US-PONB-06 — Unpublish and come back freely
...
- **Tests:** `unpublish-republish.integration.test.ts` (TC-PONB-06a + idempotent unpublish), E2E `testing/playwright/provider-unpublish-republish.e2e.ts` (live-stack-seeded, axe on confirm step).
