---
title: DDD — US-PONB-05 — Edit live, always
updated: 2026-09-04
---

# US-PONB-05 — Edit live, always
...
- **Tests:** `edit-live-always.integration.test.ts` (TC-PONB-05a/b), `badge-read.test.ts`, E2E `testing/playwright/provider-edit-live.e2e.ts` (live-stack-seeded, axe on edit page). Dev helper `POST /api/dev/grant-identity-badge` (ALLOW_DEV_HELPERS only) seeds verified state for TC-PONB-05b.
