---
title: DDD — US-REV-04 — Ratings I can search by, fairly
updated: 2026-09-04
---

# US-REV-04 — Ratings I can search by, fairly
...
- The "highly rated" query intent maps to the configured threshold (default ≥ 4.5 average with ≥ 3 reviews).
- No-review providers display "New" on cards and profiles and are excluded from minimum-rating filters, not ranked as zero.

## 3. Traces

FR-REV-05, FR-SRCH-02.
