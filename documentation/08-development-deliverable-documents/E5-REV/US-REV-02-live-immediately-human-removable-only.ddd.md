---
title: DDD — US-REV-02 — Live immediately, human-removable only
updated: 2026-09-04
---

# US-REV-02 — Live immediately, human-removable only
...
FR-REV-02, FR-REV-07, FR-ADM-05.

## 4. Build blueprint

**Primary LLD module:** `provider-reviews` (`../../05-low-level-design/06-provider-reviews/provider-reviews-lld.md`)
**Supporting modules:** `moderation-admin` (`../../05-low-level-design/08-moderation-admin/moderation-admin-lld.md`)
