---
title: DDD — US-VERIF-02 — A human decides; the badge follows
updated: 2026-09-04
---

# US-VERIF-02 — A human decides; the badge follows
...
FR-TRUST-02, FR-ADM-02, FR-NOTIF-01.

## 4. Build blueprint

**Primary LLD module:** `trust-and-safety` (`../../05-low-level-design/07-trust-and-safety/trust-and-safety-lld.md`)
**Supporting modules:** `moderation-admin` (`../../05-low-level-design/08-moderation-admin/moderation-admin-lld.md`); `user-notifications` (`../../05-low-level-design/11-user-notifications/user-notifications-lld.md`)
