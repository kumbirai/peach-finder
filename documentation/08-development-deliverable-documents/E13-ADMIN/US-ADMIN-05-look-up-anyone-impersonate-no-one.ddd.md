---
title: DDD — US-ADMIN-05 — Look up anyone, impersonate no one
updated: 2026-09-04
---

# US-ADMIN-05 — Look up anyone, impersonate no one
...
**Supporting modules:** `identity-and-access` (`../../05-low-level-design/01-identity-and-access/identity-and-access-lld.md`); `listing-billing` (`../../05-low-level-design/09-listing-billing/listing-billing-lld.md`)
